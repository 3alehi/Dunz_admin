...
`,Ee=t=>{const{locale:n}=X,r=xe(t.value,"MM","latn");return e.createElement(De,null,ke[n].months.map((n=>e.createElement(Me,{key:n.key,className:"zm-MonthPickerButton",width:90,height:48,"data-selected":n.key===parseInt(r,10),onClick:()=>t.onMonthSelect(n.key),"aria-current":"date",type:"button",tabIndex:0},n.name))))},Ye=s.div`
  ...
  padding-top: 8px;
  padding-bottom: 8px;
`,_e=t=>{const n=parseInt(xe(t.value,"YYYY","latn"),10),o=r((()=>((e,t=80,n=50)=>{const r=parseInt(ue(e,"latn"),10),o=r+n,a=[];for(let e=r-t;e<=o;e++)a.push(e);return a})(t.value)),[]),a=e.useCallback((e=>{if(null===e)return;const t=e.querySelector("button[data-selected=true]");if(null!=t){const{height:n,top:r}=e.getBoundingClientRect(),{top:o}=t.getBoundingClientRect();e.scrollTop=Math.abs(r-o)-n/2}}),[]);return e.createElement(Ye,{ref:a},o.map((r=>e.createElement(Me,{className:"zm-YearPickerButton",key:r,width:90,height:48,"data-selected":n===r,"aria-selected":n===r,"aria-current":"date",type:"button",tabIndex:0,onClick:()=>t.onYearSelect(r)},U(r)))))},Ce=e=>!0===e.range,Se=e=>{const[t,n]=o(!1),[r,a]=o(void 0!==e.from?new Date(e.from):void 0),[i,s]=o(void 0!==e.to?new Date(e.to):void 0),l=(t,n)=>{"function"==typeof e.onChange&&Ce(e)&&null!=t&&null!=n&&e.onChange({from:t,to:n})};return{handlers:Object.assign({onClick:o=>!0===e.range?(e=>{const{value:o}=e.currentTarget.dataset;t||(void 0!==o&&(a(new Date(o)),s(null)),n(!0)),t&&null===i&&(void 0!==o&&(s(new Date(o)),l(r,new Date(o))),n(!1)),t&&void 0!==i&&(l(r,i),n(!1))})(o):(t=>{const{value:n,disabled:r}=t.currentTarget.dataset;if(void 0!==n&&"true"!==r)return Ce(e)||"function"!=typeof e.onChange||e.onChange({value:new Date(n)}),n})(o)},!0===e.range&&{onMouseMove:e=>{const{value:n}=e.currentTarget.dataset;t&&void 0!==n&&te(n).isAfter(te(r))&&s(new Date(n))}}),from:r,to:i}},Te=(n,a)=>{const{locale:i}=X,{defaultValue:s,weekends:l,range:c=!1}=n,u=void 0===s?new Date:s,d=r((()=>be(s)),[]),[m,h]=o([d]),[f,p]=o("days"),y=t([]),g=(({daysElementRefs:e,days:n,setDays:r})=>{const o=t(!1),a=n[0].middleOfMonth;return{slideToTheNextMonth:()=>{if(o.current)return;const t=te(a).add(1,"month"),i=be(t.toDate());r([...n,i]),requestAnimationFrame((()=>{o.current=!0;const[t,n]=e.current;t.style.transition=`transform 250ms ${C}`,t.style.transform=`translateX(${$e()}px)`,n.style.transition=`transform 250ms ${C}`,n.style.transform=`translateX(${$e()}px)`,setTimeout((()=>{r((e=>e.filter((e=>e.id===i.id)))),n.style.transition=null,n.style.transform=null,o.current=!1}),300)}))},slideToPrevMonth:()=>{if(o.current)return;const t=te(a).subtract(1,"month"),i=be(t.toDate());r([i,...n]),requestAnimationFrame((()=>{o.current=!0;const[t,n]=e.current;t.style.transform=`translateX(${$e()}px)`,n.style.transform=`translateX(${$e()}px)`,requestAnimationFrame((()=>{n.style.transition=`transform 250ms ${C}`,n.style.transform="translateX(0px)",t.style.transition=`transform 250ms ${C}`,t.style.transform="translateX(0px)",setTimeout((()=>{r((e=>e.filter((e=>e.id===i.id)))),t.style.transition=null,t.style.transform=null,o.current=!1}),300)}))}))}}})({daysElementRefs:y,days:m,setDays:h}),{from:v,to:x,handlers:b}=Se(n);return e.createElement(F,{ref:a,className:null!==n.className?n.className:""},e.createElement(K,{monthName:m[0].monthName,onNextClick:()=>{if("days"===f)return g.slideToTheNextMonth()},onPrevClick:()=>{if("days"===f)return g.slideToPrevMonth()},onClickOnTitle:()=>{p("month"!==f&&"year"!==f?"year":"days")}}),"year"===f?e.createElement(_e,{value:u,onYearSelect:e=>{const t=((e,t)=>{const n=t-parseInt(ue(e,"latn"),10);return n>0?te(e).add(n,"years").toDate():te(e).subtract(Math.abs(n),"years").toDate()})(u,e);h([be(t)]),p("month")}}):null,"month"===f?e.createElement(Ee,{value:u,onMonthSelect:e=>{const t=((e,t)=>{const n=t-parseInt(de(e,"latn"),10);return n>0?te(e).add(n,"months").toDate():te(e).subtract(Math.abs(n),"months").toDate()})(m[0].middleOfMonth,e);h([be(t)]),p("days")}}):null,"days"===f?e.createElement(e.Fragment,null,e.createElement(P,null,ke[i].shortWeekDays.map((t=>e.createElement(Q,{key:t.key},t.name)))),e.createElement(A,null,m.map(((t,r)=>e.createElement(W,{key:t.id,className:"item",ref:e=>{y.current[r]=e},role:"rowgroup"},t.weeks.map(((t,r)=>e.createElement(z,{key:r,role:"row","aria-rowindex":r+1},t.map(((t,r)=>e.createElement(Me,Object.assign({key:t.date.getTime(),className:"zm-DaysButton","data-value":t.date,"data-disabled":t.disabled,"data-range":n.range,"data-selected":!c&&pe(u,t.date),"data-start-range":null!=v&&pe(v,t.date),"data-in-range":ye(t.date,v,x),"data-end-range":null!=x&&pe(x,t.date),"data-weekend":null==l?void 0:l.some((e=>e===r)),type:"button",role:"gridcell","aria-colindex":r+1,tabIndex:0,"aria-selected":!c&&pe(u,t.date)},b),e.createElement(we,{className:"cl-text"},xe(t.date,"DD"))))))))))))):null)};Te.displayName="Calendar";var Oe=a(Te);function Le(e,t){n((()=>{function n({target:n}){null==e.current||e.current.contains(n)||t()}return document.addEventListener("mousedown",n),()=>{document.removeEventListener("mousedown",n)}}),[e,t])}const Ne=(e,t,n)=>`hsl(${e}deg ${t}% ${n}%)`,Ie=e=>{const{h:t,s:n,l:r}=function(e){const t=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(e);if(null==t)throw new Error("Could not parse Hex Color");const n=parseInt(t[1],16)/255,r=parseInt(t[2],16)/255,o=parseInt(t[3],16)/255,a=Math.max(n,r,o),i=Math.min(n,r,o);let s=(a+i)/2,l=s,c=s;if(a===i)return{h:0,s:0,l:c};const u=a-i;switch(l=c>.5?u/(2-a-i):u/(a+i),a){case n:s=(r-o)/u+(r<o?6:0);break;case r:s=(o-n)/u+2;break;case o:s=(n-r)/u+4}return s/=6,l*=100,l=Math.round(l),c*=100,c=Math.round(c),s=Math.round(360*s),{h:s,s:l,l:c}}(e),o={};return o[40]=Ne(t,n,r-10),o[50]=Ne(t,n,r),o[85]=Ne(t,n,85),o[90]=Ne(t,n,90),o[95]=Ne(t,n,95),o},He={0:"#FFFFFF",20:"#F5F5F5",30:"#EBEBEB",40:"#DEDEDE",50:"#BFBFBF",60:"#B0B0B0",70:"#575757",80:"#666666",600:"#2E2E2E"},je=t=>{const{accentColor:n=S,locale:o,round:a="thin",direction:i="rtl"}=t;r((()=>X.setLocale(o)),[o]);const s={colors:{primary:r((()=>Ie(n)),[]),gray:He},round:a,direction:i};return e.createElement(c,{theme:s},t.children)},Be=n=>{const{defaultValue:a,locale:i="fa",weekends:s=[],direction:l="rtl",accentColor:c}=n;r((()=>X.setLocale(i)),[i]);const u=t(null),d=t(null),[m,h]=o(void 0!==a?new Date(a):void 0),[f,p]=o(!0===n.range&&void 0!==n.from?new Date(n.from):void 0),[y,g]=o(!0===n.range&&void 0!==n.to?new Date(n.to):void 0),[v,x]=o(!1);Le(d,(()=>x(!1)));const b=()=>{x(!v)},$=r((()=>{var e;const t=null!==(e=null==n?void 0:n.customShowDateFormat)&&void 0!==e?e:ke[i].format;return void 0===n.range&&void 0!==m?xe(m,t):(console.log("from >>",f),void 0!==f&&void 0!==y?`\n        ${xe(f,t)}\n        -\n        ${xe(y,t)}\n      `:"")}),[m,f,y]);return e.createElement(je,{accentColor:c,round:n.round,direction:l},e.createElement("input",Object.assign({ref:u},null==n?void 0:n.inputAttributes,{onClick:b,type:"text",value:$,className:null!==n.inputClass?n.inputClass:"",readOnly:!0})),e.createElement(j,{toggleOpen:b,showCalendar:v,destinationRef:u,position:n.position},e.createElement(Oe,{defaultValue:m,ref:d,className:n.className,weekends:s,onChange:e=>{if(!0===n.range&&"function"==typeof n.onChange){const t="from"in e?e.from:new Date,r="to"in e?e.to:new Date;p(t),g(r),n.onChange({from:t,to:r})}else if((!1===n.range||void 0===n.range)&&"function"==typeof n.onChange){const t="value"in e?e.value:new Date;h(t),n.onChange({value:t})}},range:n.range,from:!0===n.range?n.from:void 0,to:!0===n.range?n.to:void 0})))},Fe=s.div`
  width: 260px;
  height: 260px;
  position: relative;
  z-index: 1;
